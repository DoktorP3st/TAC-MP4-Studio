...
# ── Version ───────────────────────────────────────────────────────────────────
VERSION = "1.9.0"   # v1.9 — Mode export VERTICAL 9:16 complet + corrections bugs spectre
...
class App(PagesMixin, EditorMixin, PreviewMixin, ctk.CTk if not _DND_AVAILABLE else TkinterDnD.Tk):
    ...
    def _open_settings_window(self):
        ...
        socials = [
            ("🟣  Twitch — Pestovich",       "https://www.twitch.tv/Pestovich"),
        ...
        about_text = (
            ...
            "Développé par Pestovich · Licence MIT"
        )
